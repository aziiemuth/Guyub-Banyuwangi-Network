...
if ($isAdmin) {
  ...
  $menuItems[] = ['slug' => 'keuangan', 'icon' => 'bi-currency-dollar', 'label' => 'Catatan Keuangan', 'href' => 'keuangan.php'];
...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?= $rootPath ?? '' ?>auth/logout.php" onclick="return confirm('Yakin ingin logout?')">

...
<body class="app-wrapper">
  ...
  <div class="page-header">
    <div>
      ...
      <p class="text-truncate" style="max-width:100%"><?= date('d F Y') ?> — <?= htmlspecialchars($periode_aktif['nama_periode'] ?? 'Belum ada periode aktif') ?></p>
    </div>
  </div>
  ...
  <?php if ($role === 'admin'): ?>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form method="post" action="proses_bayar.php">
            ...
            <div class="d-flex gap-2 flex-wrap admin-bayar-row">
              <select name="anggota_id" class="form-select form-select-sm" required style="min-width:120px;flex:1">
              ...
              <input type="number" name="nominal" class="form-control form-control-sm" style="width:110px"
                placeholder="Nominal" min="0" value="0">
              <select name="metode" class="form-select form-select-sm" style="width:110px">
    ...
    <div class="card mb-3">
      <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div class="d-flex gap-2 tab-filter-row" style="overflow-x:auto;-webkit-overflow-scrolling:touch;padding-bottom:2px">
                      ...
                      <div class="d-flex gap-1">
                        <?php if ($show === 'pending'): ?>
                          <a href="#" class="btn btn-sm btn-success"
                            onclick="return gbnConfirm('validasi_pembayaran.php?id=<?= $d['id'] ?>', 'Validasi pembayaran ini?', 'success', 'Validasi Pembayaran')">
                        ...
                        <?php endif; ?>
                        <a href="#"
                          class="btn btn-sm btn-outline-danger" onclick="return gbnConfirm('batalkan_transaksi.php?id=<?= $d['id'] ?>&anggota=<?= $d['anggota_id'] ?>', 'Batalkan transaksi ini? Tindakan tidak bisa diurungkan.', 'danger', 'Batalkan Transaksi?')">
